...
void pwm(void);
void initiate(void);
unsigned char pwmlow20, pwmhigh20, pwmlow60, pwmhigh60, pwmlow90, pwmhigh90;
...
void initiate(void){
    ...
    float dutyCycle20 = 36.8;
    float dutyCycle60 = 110.4;
    float dutyCycle90 = 165.6;

    pwmlow20 = ((unsigned int)(dutyCycle20) & 0x03);
    pwmhigh20 = (unsigned int)(dutyCycle20) >> 2;

    pwmlow60 = ((unsigned int)(dutyCycle60) & 0x03);
    pwmhigh60 = (unsigned int)(dutyCycle60) >> 2;

    pwmlow90 = ((unsigned int)(dutyCycle90) & 0x03);
    pwmhigh90 = (unsigned int)(dutyCycle90) >> 2;
