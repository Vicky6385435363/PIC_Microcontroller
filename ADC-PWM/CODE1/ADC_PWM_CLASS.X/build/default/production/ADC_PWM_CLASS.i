...
unsigned char msg_1[9] = {"ADC RAW: "};
unsigned char msg_2[9] = {"ADC CAL: "};
unsigned int m, adc_low, adc_high;
unsigned long result, volt;
unsigned int d3, d4, d1, d2;
...
void main(void) {
    ...
    while (1) {
        ...
        adc_high = ADRESH;
        adc_low = ADRESL;
        result = ((unsigned long) adc_high << 8) | ((unsigned long) adc_low);

        volt = (unsigned long) ((result * 338) / 1023);
...
void lcd_output(unsigned int i) {
    unsigned int m;
    m = i;
    d4 = (unsigned char) (m / 1000);
    d3 = (unsigned char) ((m - (d4 * 1000)) / 100);
    d2 = (unsigned char) ((m - (d4 * 1000)-(d3 * 100)) / 10);
    d1 = (unsigned char) (m - (d4 * 1000)-(d3 * 100)-(d2 * 10));
