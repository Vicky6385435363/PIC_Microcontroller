...
int Date = 31, Month = 12, Year = 24;
char Seconds1, Seconds2, Minutes1, Minutes2, Hours1, Hours2, Date1, Date2, Month1, Month2, Year1, Year2;
...
void settime(void) {
    ...
    I2C_write(0xD0);
    I2C_write(0x00);
    I2C_write(dec_2_bcd(Seconds));
    I2C_write(dec_2_bcd(Minutes));
    I2C_write(dec_2_bcd(Hours));
    I2C_write(0x00);
...
void upDate(void) {
    ...
    I2C_start();
    I2C_write(0xD1);
    Seconds = bcd_2_dec(I2C_read(1));
    Minutes = bcd_2_dec(I2C_read(1));
    Hours = bcd_2_dec(I2C_read(1));
    (I2C_read(1));
